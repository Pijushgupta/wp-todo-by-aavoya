<template>
<div class="p-2">
	<!-- Sharing Dialog Box: popup -->
	<div v-show="openAddTagDialog" class="absolute inset-0 w-full flex justify-center items-center z-10  backdrop-blur dark:bg-gray-900 bg-white bg-opacity-80  ">
	...
	<!-- ends -->
	<div class="tag-area border border-gray-200 dark:border-gray-800 rounded-lg flex flex-row-reverse  p-2  overflow-x-auto scroll scroll-smooth whitespace-nowrap tw-scroll-bar">
			<div @click="openAddTagDialog = !openAddTagDialog" class="flex flex-row">
				<div class="bg-blue-700  rounded-full text-white w-10  h-10  flex items-center justify-center cursor-pointer"><svg xmlns="http://www.w3.org/2000/svg" class="h-5 w-5 inline fill-white" viewBox="0 0 20 20" fill="currentColor"> <path d="M8 9a3 3 0 100-6 3 3 0 000 6zM8 11a6 6 0 016 6H2a6 6 0 016-6zM16 7a1 1 0 10-2 0v1h-1a1 1 0 100 2h1v1a1 1 0 102 0v-1h1a1 1 0 100-2h-1V7z" /> </svg>
				</div>
			</div>
